...
namespace Drm\BlogBundle\Tests\Twig\Extensions;

use Drm\BlogBundle\Twig\Extensions\DrmBlogExtension;

class DrmBlogExtensionTest extends \PHPUnit_Framework_TestCase
{

	public function testCreatedAgo()
	{
		$blog = new DrmBlogExtension ();
