...
class PageControllerTest extends WebTestCase
{
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/whoami');
        
        $expected = $crawler->filter('h2:contains("whoami")')->count();
    ...
    public function testDisclaimer ()
    {
        ...
        $expected = $crawler->filter('h2:contains("Disclaimer")')->count();
    ...
    public function testContact_MethodGet ()
    {
        ...
        $expected = $crawler->filter('h2:contains("Contact Me")')->count();
    ...
    public function testContact_MethodPost ()
    {
        ...
        $form = $crawler->selectButton('Contact Me')->form();
        ...
        $expected = $redirect->filter(
                '.alert-info:contains("Your contact enquiry was successfully sent. Thank you!")')->count();
