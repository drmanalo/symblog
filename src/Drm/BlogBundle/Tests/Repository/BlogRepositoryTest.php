<?php
namespace Drm\BlogBundle\Tests\Repository;
...
class BlogRepositoryTest extends WebTestCase
{
    ...
    public function setUp ()
    {
        ...
        $this->blogRepository = $kernel->getContainer()
            ...
            ->getRepository('DrmBlogBundle:Blog');
    }
    ...
    public function testGetTags ()
    {
        ...
        $this->assertContains('linux', $tags);
    }
    ...
    public function testGetTagWeights ()
    {
        ...
        $tagsWeight = $this->blogRepository->getTagWeights(
                array_merge(array_fill(0, 10, 'php'), 
                        array_fill(0, 2, 'html'), array_fill(0, 6, 'js')));
